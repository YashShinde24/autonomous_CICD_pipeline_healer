...
from app.agents.nodes.fix_genrator import generate_fix
from app.agents.nodes.fix_validator import validate_fix
from app.agents.nodes.git_committer import commit_fix
from app.agents.nodes.git_commitor import run as git_commitor_run
...
fix_genrator = type('FixGenerator', (), {'run': generate_fix})()
fix_validator = type('FixValidator', (), {'run': validate_fix})()
git_committer = type('GitCommitter', (), {'run': commit_fix})()
